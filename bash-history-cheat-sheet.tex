...
%
% by Peter Krumins (peter@catonmat.net, @pkrumins on twitter)
...
\hypersetup{pdfauthor={Peter Krumins (peter@catonmat.net)}}
...
\framebox{\parbox{5in}{
A cheat sheet by \textbf{Peter Krumins} (\href{mailto:peter@catonmat.net}{peter@catonmat.net}, \href{https://twitter.com/pkrumins}{@pkrumins} on twitter)

\href{http://www.catonmat.net}{www.catonmat.net} -- good coders code, great coders reuse
...
\framebox{\parbox{5in}{
A cheat sheet by \textbf{Peter Krumins} (peter@catonmat.net, \href{https://twitter.com/pkrumins}{@pkrumins} on twitter)
